...
func TestUpcloudServer_removeBackupRule(t *testing.T) {
	s1 := utils.ReadTestDataFile(t, "../testdata/upcloud_server/server_backup_rule_s1.tf")
	s2 := utils.ReadTestDataFile(t, "../testdata/upcloud_server/server_backup_rule_s2.tf")
