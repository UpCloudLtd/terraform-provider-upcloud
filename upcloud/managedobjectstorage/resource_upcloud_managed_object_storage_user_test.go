...
func TestAccUpcloudManagedObjectStorageUser(t *testing.T) {
	testDataS1 := utils.ReadTestDataFile(t, "testdata/managed_object_storage_user_s1.tf")
	testDataS2 := utils.ReadTestDataFile(t, "testdata/managed_object_storage_user_s2.tf")
