		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(name, prop("autovacuum_analyze_scale_factor"), "1"),
					...
					resource.TestCheckResourceAttr(name, prop("autovacuum_vacuum_scale_factor"), "1"),
					...
					resource.TestCheckResourceAttr(name, prop("bgwriter_lru_multiplier"), "1"),
					resource.TestCheckResourceAttr(name, prop("deadlock_timeout"), "501"),
					resource.TestCheckResourceAttr(name, prop("idle_in_transaction_session_timeout"), "1"),
					...
					resource.TestCheckResourceAttr(name, prop("version"), "13"),
					...
					resource.TestCheckResourceAttr(name, prop("pgbouncer.0.server_idle_timeout"), "1"),
