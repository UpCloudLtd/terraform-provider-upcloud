		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(cbd1Name, "labels.%", "1"),
					...
					resource.TestCheckResourceAttr(cbm1Name, "labels.%", "1"),
			...
			verifyImportStep(cbm1Name, "operational_state", "private_key"),
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(cbd1Name, "labels.%", "2"),
					...
					resource.TestCheckResourceAttr(cbm1Name, "labels.%", "0"),
				),
			},
			{
				Config: testDataS3,
